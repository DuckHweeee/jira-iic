...
export const EditWorkspaceForm = ({
  ...
  const handleResetInviteCode = async () => {
    ...
    resetInviteCode({ param: { workspaceId: initalValues.$id } });
  };
  ...
  const fullInviteLink = `${window.location.origin}/workspace/${initalValues.$id}/join/${initalValues.inviteCode}`;
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            <h3 className="font-bold text-red-600">Invite Members</h3>
            <p className="text-sm text-muted-foreground">
